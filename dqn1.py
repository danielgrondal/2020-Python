#From https://towardsdatascience.com/why-going-from-implementing-q-learning-to-deep-q-learning-can-be-difficult-36e7ea1648af

# Note that depending on the details of the environment, there are a few extra steps required to “plug in” the agent 
# and get something functional. In particular, something mapping action indices to actions the environment understands 
# almost always needs to be done. Nevertheless, I hope the following provides some value and speeds up your own experiments.
